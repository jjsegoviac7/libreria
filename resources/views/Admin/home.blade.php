  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Virtua MX</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered">BIENVENIDOS</h5>
              	  	
                  <li class="mt">
                      <a href="listar.html">
                          <i class="fa fa-dashboard"></i>
                          <span>Mostrar Libros</span>
                      </a>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="libros.index.php">Blank Page</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> REGISTRO DE LIBROS</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          		<p>
...
@endif 
  <div class="col-md-10">
    ...
    <form class ="form-group"  action="{{route('guardarlibro')}}" method="post">
      {{csrf_field()}}
  </div>
  <br></br>
